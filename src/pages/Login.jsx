...
import tractorImg from '../assets/images/header_hq.webp';
            ...
            <>
              ...
              <form className={styles.form} onSubmit={handleSubmit} noValidate>
                ...
                <div className={styles.optionsRow} style={{ justifyContent: 'flex-end', marginTop: '8px' }}>
                  <a href="#" className={styles.forgotLink} onClick={(e) => { e.preventDefault(); setView('forgot'); setError(''); setResetSent(false); }}>¿Olvidaste tu contraseña?</a>
                </div>
              ...
              <form className={styles.form} onSubmit={handleResetPassword} noValidate>
                ...
                {resetSent && (
                  <div className={styles.error} style={{ background: '#dcfce7', color: '#166534', border: '1px solid #bbf7d0' }} role="alert">
                    <span>Enlace enviado. Revisa tu bandeja de entrada o spam.</span>
                  </div>
                )}

                <div className={styles.field}>
                  <label htmlFor="resetEmail" className={styles.label}>Correo electrónico</label>
                  <input id="resetEmail" type="email" className={styles.input}
                    value={email} onChange={e => setEmail(e.target.value)}
                ...
                <div className={styles.footerLinks} style={{ marginTop: '24px' }}>
                  <a href="#" className={styles.forgotLink} onClick={(e) => { e.preventDefault(); setView('login'); setError(''); }}>
