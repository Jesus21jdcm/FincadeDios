  ...
  return (
    <header className={styles.header}>
      ...
      <div style={{ display: 'flex', alignItems: 'center' }}>
        <svg width="115" height="33" viewBox="0 0 100 28" fill="none" xmlns="http://www.w3.org/2000/svg">
          <text x="0" y="21" fontFamily="'Poppins', sans-serif" fontWeight="800" fontSize="17" fill="var(--color-foreground)" letterSpacing="0.5">FINCA</text>
          <text x="50" y="21" fontFamily="'Poppins', sans-serif" fontWeight="800" fontSize="17" fill="var(--color-cyan)" letterSpacing="0.5">DIGI</text>
        </svg>
      </div>
